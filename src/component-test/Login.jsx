...
export function LoginPage(){
    ...
    // we store an object. perfect for sendin multiple data
    ...
    return(
        ...
        <section id='container'>
                <section id="loginContainer" >
                    <img src= {image} alt="" />
                    <div id='form'>
                        <label htmlFor="" id='headText'>Login</label>
                            <div className="inputContainer">
                                <FontAwesomeIcon icon={faUser} 
                                  className={`animate__animated inputIcon ${username ? 'smoothBounce' : ''}`} 
                                />
                            ...
                            <div className="inputContainer">
                                <FontAwesomeIcon icon={faEye}
                                 className={`inputIcon animate__animated ${password ? 'smoothBounce' : ''}`} 
                                 />
                                <input type="password" 
                        ...
                        <button id='loginBtn' onClick={goToHome}> Login </button>
                    </div>
                </section>
        </section>
        </>
